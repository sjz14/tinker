...
// File         : test_send_b.cpp
// Creation Date: 2014-05-22
// Last modified: 2014-05-22, 00:49:09
// Description  : 
// 
...
{
    ros::init(argc, argv, "test_send_b");
    ros::NodeHandle n;
    ros::Rate rate(33);
